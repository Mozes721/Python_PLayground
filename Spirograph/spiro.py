...
class Spiro:
    ...
    def setparams(self, xc, yc, col, R, r, l):
        ...
        self.l = l 
        self.col = col  
        #reduce r/R to its smallest form by dividng with the GCD 
